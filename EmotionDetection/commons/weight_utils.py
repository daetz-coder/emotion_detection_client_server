...
from EmotionDetection.commons import folder_utils, package_utils
...
def download_all_models_in_one_shot() -> None:
    ...
    from EmotionDetection.models.facial_recognition.VGGFace import WEIGHTS_URL as VGGFACE_WEIGHTS
    from EmotionDetection.models.demography.Emotion import WEIGHTS_URL as EMOTION_WEIGHTS
    from EmotionDetection.models.spoofing.FasNet import (
        FIRST_WEIGHTS_URL as FASNET_1ST_WEIGHTS,
        SECOND_WEIGHTS_URL as FASNET_2ND_WEIGHTS,
    )
    from EmotionDetection.models.face_detection.Yolo import (
